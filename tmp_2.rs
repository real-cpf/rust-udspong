...
async fn handler(
    ...
    Peer::new(state.clone(), transport, String::from("value"));
...
fn main()-> io::Result<()>{
    ...
    let mut channelMap : HashMap<String,mio::net::UnixStream> = HashMap::new();
            ...
            match event.token() {
                ...
                token => {
                    ...
                    let done = if let Some(connection) = connections.get_mut(&token) {
                        channelMap.insert("k".to_string(), connection);
